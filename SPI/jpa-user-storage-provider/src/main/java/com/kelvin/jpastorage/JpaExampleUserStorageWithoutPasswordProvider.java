...
@Slf4j
public class JpaExampleUserStorageWithoutPasswordProvider implements UserStorageProvider,
        UserLookupProvider,
    ...
    public JpaExampleUserStorageWithoutPasswordProvider(UserRepository userRepository, ComponentModel model, KeycloakSession session) {
